...
<head>
    <title>Code coverage report for vue-cli-plugin-electron-builder/lib/testWithSpectron.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">vue-cli-plugin-electron-builder/lib</a> testWithSpectron.js</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">const execa = require('execa')
...
module.exports = (spectron, options = {}) =&gt;
  ...
  new Promise(async (resolve, reject) =&gt; {
    ...
    child.on('error', <span class="fstat-no" title="function not covered" >(e</span>rr) =&gt; {
    ...
    child.stdout.on('data', async (data) =&gt; {
      ...
      if (urlMatch) {
        ...
        resolve({
          ...
          url,
          app,
          stopServe: <span class="fstat-no" title="function not covered" >()</span> =&gt; {
            // Exit serve process
<span class="cstat-no" title="statement not covered" >            child.stdin.write('close')</span>
<span class="cstat-no" title="statement not covered" >            child.kill()</span>
            // Close spectron
<span class="cstat-no" title="statement not covered" >            if (app &amp;&amp; app.isRunning()) <span class="cstat-no" title="statement not covered" >return app.stop()</span></span>
          }
        })
      }
    })
