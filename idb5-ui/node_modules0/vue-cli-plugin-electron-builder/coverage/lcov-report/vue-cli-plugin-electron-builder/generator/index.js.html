...
<head>
    <title>Code coverage report for vue-cli-plugin-electron-builder/generator/index.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">vue-cli-plugin-electron-builder/generator</a> index.js</h1>
        <div class='clearfix'>
...
&nbsp;
module.exports = (api, options = <span class="branch-0 cbranch-no" title="branch not covered" >{})</span> =&gt; {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!options.electronBuilder) <span class="cstat-no" title="statement not covered" >options.electronBuilder = {}</span>
...
&nbsp;
  const devtoolsExtensionsBroken = semver.gte(
    (electronVersion || <span class="branch-1 cbranch-no" title="branch not covered" >pkg.devDependencies.electron)</span>.replace('^', ''),
    '6.0.0'
  )
  <span class="missing-if-branch" title="else path not taken" >E</span>if (devtoolsExtensionsBroken) {
  ...
  // Add tests
  let testFramework
  <span class="missing-if-branch" title="if path not taken" >I</span>if (options.electronBuilder.addTests) {
<span class="cstat-no" title="statement not covered" >    if (api.hasPlugin('unit-mocha')) <span class="cstat-no" title="statement not covered" >testFramework = 'mocha'</span></span>
<span class="cstat-no" title="statement not covered" >    if (api.hasPlugin('unit-jest')) <span class="cstat-no" title="statement not covered" >testFramework = 'jest'</span></span>
<span class="cstat-no" title="statement not covered" >    if (testFramework) <span class="cstat-no" title="statement not covered" >api.render(`./templates/tests-${testFramework}`)</span></span>
  }
...
&nbsp;
    if (usesTS) {
      ...
      } else <span class="missing-if-branch" title="else path not taken" >E</span>if (fs.existsSync(api.resolve('./src/background.ts'))) {
...
<span class="cstat-no" title="statement not covered" >        return</span>
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (api.hasPlugin('router')) {
<span class="cstat-no" title="statement not covered" >      console.log('\n')</span>
<span class="cstat-no" title="statement not covered" >      require('@vue/cli-shared-utils/lib/logger').warn(</span>
...
&nbsp;
  ...
  <span class="missing-if-branch" title="else path not taken" >E</span>if (electronVersion) {
    // Use provided electron version
    devDependencies.electron = electronVersion
  }
  const dependencies = {}
  <span class="missing-if-branch" title="if path not taken" >I</span>if (testFramework) {
    // Spectron version should be electron version + 2
<span class="cstat-no" title="statement not covered" >    devDependencies.spectron =</span>
      '^' +
      (parseInt(
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (testFramework === 'mocha') {
<span class="cstat-no" title="statement not covered" >    dependencies['chai-as-promised'] = '^7.1.1'</span>
  }
  api.extendPackage({
    scripts,
    dependencies,
