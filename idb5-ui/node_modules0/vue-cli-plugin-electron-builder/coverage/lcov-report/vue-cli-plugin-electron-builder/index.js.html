...
<head>
    <title>Code coverage report for vue-cli-plugin-electron-builder/index.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">vue-cli-plugin-electron-builder</a> index.js</h1>
        <div class='clearfix'>
            ...
            <div class='fl pad1y space-right2'>
                <span class="strong">82.31% </span>
                <span class="quiet">Branches</span>
                <span class='fraction'>107/130</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>221/251</span>
            </div>
...
<a name='L691'></a><a href='#L691'>691</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">1x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">94x</span>
<span class="cline-any cline-yes">16309x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">const TerserPlugin = require('terser-webpack-plugin')
    ...
    async (args, rawArgs) =&gt; {
      ...
      if (args.skipBundle) {
        ...
        Object.keys(pages).forEach((page) =&gt; {
          ...
          pagePath.name = `legacy-assets-${pagePath.name || <span class="branch-1 cbranch-no" title="branch not covered" >page}</span>`
...
<span class="cstat-no" title="statement not covered" >              throw err</span>
            ...
            <span class="missing-if-branch" title="if path not taken" >I</span>if (stats.hasErrors()) {
              // eslint-disable-next-line prefer-promise-reject-errors
<span class="cstat-no" title="statement not covered" >              throw new Error('Build failed with errors.')</span>
            }
...
<span class="cstat-no" title="statement not covered" >              throw err</span>
            ...
            <span class="missing-if-branch" title="if path not taken" >I</span>if (stats.hasErrors()) {
<span class="cstat-no" title="statement not covered" >              error('Build failed with errors.')</span>
<span class="cstat-no" title="statement not covered" >              process.exit(1)</span>
            }
...
<span class="cstat-no" title="statement not covered" >            currentChild.send('graceful-exit')</span>
          } else {
...
<span class="cstat-no" title="statement not covered" >            if (!currentChild.killed) {</span>
<span class="cstat-no" title="statement not covered" >              warn(`Force killing Electron (process #${currentChild.pid})`)</span>
<span class="cstat-no" title="statement not covered" >              currentChild.kill('SIGKILL')</span>
            }
          }, 2000)
        })
&nbsp;
      ...
      chokidar
        ...
        .on('all', () =&gt; {
          ...
          <span class="missing-if-branch" title="else path not taken" >E</span>if (firstBundleCompleted) {
            startElectron()
          }
        })
&nbsp;
      // Attempt to kill gracefully on SIGINT and SIGTERM
      const signalHandler = <span class="fstat-no" title="function not covered" >()</span> =&gt; {
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        killElectron()</span>
      }
&nbsp;
      <span class="missing-if-branch" title="if path not taken" >I</span>if (!process.env.IS_TEST) <span class="cstat-no" title="statement not covered" >process.on('SIGINT', signalHandler)</span>
      <span class="missing-if-branch" title="if path not taken" >I</span>if (!process.env.IS_TEST) <span class="cstat-no" title="statement not covered" >process.on('SIGTERM', signalHandler)</span>
&nbsp;
      // Handle Ctrl+C on Windows
      <span class="missing-if-branch" title="if path not taken" >I</span>if (process.platform === 'win32' &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >!process.env.IS_TEST)</span> {
<span class="cstat-no" title="statement not covered" >        readline</span>
          .createInterface({
            input: process.stdin,
            output: process.stdout
          })
          .on('SIGINT', <span class="fstat-no" title="function not covered" >()</span> =&gt; {
...
&nbsp;
      async function launchElectron() {
        ...
        const waitTimeout = setTimeout(<span class="fstat-no" title="function not covered" >()</span> =&gt; {
          // If killing Electron takes over 500ms:
<span class="cstat-no" title="statement not covered" >          info('Waiting for Electron to exit...')</span>
        }, 500)
        await killElectron()
        clearTimeout(waitTimeout)
        // Don't launch if a new background file is being bundled
        queuedBuilds--
        <span class="missing-if-branch" title="if path not taken" >I</span>if (queuedBuilds &gt; 0) <span class="cstat-no" title="statement not covered" >return</span>
&nbsp;
        if (args.debug) {
        ...
        } else <span class="missing-if-branch" title="if path not taken" >I</span>if (args.headless) {
          // Log information for spectron
<span class="cstat-no" title="statement not covered" >          console.log(`$outputDir=${outputDir}`)</span>
<span class="cstat-no" title="statement not covered" >          console.log(`$WEBPACK_DEV_SERVER_URL=${server.url}`)</span>
        } else {
...
&nbsp;
          ...
          <span class="missing-if-branch" title="if path not taken" >I</span>if (process.platform === 'win32') <span class="cstat-no" title="statement not covered" >stdioConfig.push('ipc')</span>
&nbsp;
          child = execa(
            require('electron'),
            [
...
&nbsp;
      function <span class="fstat-no" title="function not covered" >onChildExit(</span>) {
<span class="cstat-no" title="statement not covered" >        process.exit(0)</span>
      }
    }
  )
...
<span class="fstat-no" title="function not covered" >    (a</span>rgs, rawArgs) =&gt; {
<span class="cstat-no" title="statement not covered" >      warn('This command is deprecated. Please use electron:build instead.')</span>
<span class="cstat-no" title="statement not covered" >      return api.service.run(</span>
        'electron:build',
...
<span class="fstat-no" title="function not covered" >    (a</span>rgs, rawArgs) =&gt; {
<span class="cstat-no" title="statement not covered" >      warn('This command is deprecated. Please use electron:serve instead.')</span>
<span class="cstat-no" title="statement not covered" >      return api.service.run(</span>
        'electron:serve',
        { ...args, _: ['First arg is removed', ...args._] },
        ['First arg is removed', ...rawArgs]
...
&nbsp;
  ...
  } else <span class="missing-if-branch" title="if path not taken" >I</span>if (NODE_ENV === 'production') {
    // Minify for better performance
<span class="cstat-no" title="statement not covered" >    config.plugin('uglify').use(TerserPlugin, [</span>
      {
        parallel: true
      }
    ])
...
&nbsp;</pre></td></tr></table></pre>
            ...
            <div class='footer quiet pad2 space-top1 center small'>
                ...
                at Wed Jun 03 2020 18:12:53 GMT-0700 (Pacific Daylight Time)
            </div>
        </div>
