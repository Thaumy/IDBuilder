...
export default VSlider.extend({
  ...
  methods: {
    getTrackStyle(startLength, endLength) {
      let startPadding = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0;
      let endPadding = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 0;
